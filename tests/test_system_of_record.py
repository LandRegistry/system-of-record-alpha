...
class SystemOfRecordTestCase(unittest.TestCase):
    ...
    @mock.patch("systemofrecord.repository.DBStore.put")
    ...
    @mock.patch("systemofrecord.repository.DBStore.count")
    @mock.patch("redis.Redis.info")
    def test_health_returns_200(self, mock_redis, mock_db):
        response = self.app.get('/health')
        assert response.status == '200 OK'

    @mock.patch("systemofrecord.repository.DBStore.get")
    ...
    @mock.patch("systemofrecord.repository.DBStore.get", return_value=None)
